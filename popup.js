document.addEventListener("DOMContentLoaded", function () {
  ...
  if (typeof chrome != "undefind" && chrome.storage) {
    chrome.storage.sync.get(["function1s", "function2s", "function3s"], function (data) {
      ...
      function3CB.checked = data.function3s !== undefined ? data.function3s : false;
    });
    ...
    function3CB.addEventListener('change', function () {
      chrome.storage.sync.set({ "function3s": this.checked });
    });
  }
});
